...
public class Principal 
{
    ...
    String[] nombre_nodos = {"A", "B", "C", "D"};
    Double[] coordenadasX = {20.0, 13.0, 22.0, 18.0};
    Double[] coordenadasY = {3.0, 31.0, 27.0, 26.0};
    ...
    public void principal() {
        ...
        TSP tspfb = new TSP(lista_nombre_nodos, v_distancias);
